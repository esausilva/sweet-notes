...
export type NotesQuery = { __typename?: 'Query', notes?: { __typename?: 'NotesConnection', totalCount: number, nodes?: Array<{ __typename?: 'Note', message: string, createdUTC: any }> | null } | null };
